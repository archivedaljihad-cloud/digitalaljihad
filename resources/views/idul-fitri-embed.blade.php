...
<head>
	...
	<style>
		* {
		...
		/* Overlay Penyejuk Elegan: Menjaga Keterbacaan Teks Sekaligus Menonjolkan Nuansa Bedug, Ketupat & Masjid */
		.display-overlay {
			background: 
		...
		/* 6. Animasi Ayunan Lembut Bedug & Ketupat */
		.title-icon-badge.left-icon img {
			animation: festiveSwayLeft 4.5s infinite ease-in-out;
			transform-origin: top center;
		}
		.title-icon-badge.right-icon img {
			animation: festiveSwayRight 4.2s infinite ease-in-out;
			transform-origin: top center;
		}

		@keyframes festiveSwayLeft {
			0%, 100% {
			...
			25% {
				...
				filter: drop-shadow(0 0 16px rgba(255, 235, 120, 0.9));
			}
			75% {
...
<body>
		...
		<div class="schedule-header-section">
			<div class="title-with-icons">
				...
				<div class="title-text-wrap">
					...
					<div class="festive-greeting">عِيدٌ مُبَارَكٌ • كُلُّ عَامٍ وَأَنْتُمْ بِخَيْرٍ</div>
				</div>
	...
	<!-- Script Background Khusus Idul Fitri (Gambar Pilihan DKM) -->
	<script>
