<!-- resources/views/ambulance-embed.blade.php -->
<!DOCTYPE html>
<html lang="id">
...
<head>
	...
	<title>Sistem Informasi Masjid - Buku Kas Ambulance</title>
...
<body>
	...
	<div class="display-content">
		...
		<div class="container">
			<div class="header">
				...
				<h3 class="sub-header"><i class="fas fa-ambulance mr-2"></i> BUKU KAS AMBULANCE</h3>
			...
			<div class="dashboard-row">
				<div class="chart-container">
					<h3><i class="fas fa-chart-pie"></i> Grafik Kas Ambulance</h3>
				...
				<div class="transactions-container">
					<h3><i class="fas fa-history"></i> Transaksi Kas Ambulance Terbaru</h3>
					<div class="transaction-list">
							...
							<div class="transaction-info">
								...
								<div>
									...
									<div class="transaction-date">
										...
										@if($item->kategori)
											• <span style="color: #ffd700;">{{ $item->kategori }}</span>
										@endif
									</div>
								</div>
							</div>
						...
						<div class="text-center" style="padding: 30px;">
							<i class="fas fa-ambulance fa-2x" style="opacity: 0.5; color: #ffd700;"></i>
							<p style="margin-top: 10px; color: #ccc;">Belum ada transaksi kas ambulance</p>
						</div>
						@endforelse
					</div>
				</div>
	...
	<script>
		...
		// Chart Donat Kas Ambulance
		const ctx = document.getElementById('ambulanceChart').getContext('2d');
		const pemasukanVal = {{ $totalPemasukan ?? 0 }};
		const pengeluaranVal = {{ $totalPengeluaran ?? 0 }};
		const chartData = (pemasukanVal === 0 && pengeluaranVal === 0) ? [1, 0] : [pemasukanVal, pengeluaranVal];
		const chartColors = (pemasukanVal === 0 && pengeluaranVal === 0) ? ['#555555', '#333333'] : ['#00e676', '#ff6b6b'];
