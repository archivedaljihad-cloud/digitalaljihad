...
<head>
	...
	<title>Sistem Informasi Masjid - Keuangan Kas Ambulance</title>
					...
					<table id="keuangan-table">
						...
						<tbody id="keuangan-tbody" style="--scroll-duration: {{ $calcDuration }}s;">
							@if(isset($keuangan) && $keuangan->isEmpty())
								<tr>
									<td colspan="6" class="no-data">Tidak ada data kas ambulance tersedia.</td>
								</tr>
							@else
