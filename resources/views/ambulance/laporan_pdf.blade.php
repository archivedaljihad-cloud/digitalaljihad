<!-- resources/views/ambulance/laporan_pdf.blade.php -->
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
	<title>Laporan Kas Ambulance</title>
	<style>
		* {
			margin: 0;
			padding: 0;
...
<body>
	...
	<table>
		...
		<tbody>
			...
			@empty
			<tr>
				<td colspan="7" align="center">Tidak ada data transaksi kas ambulance</td>
			</tr>
			@endforelse
		</tbody>
	...
	<div class="header">
		<h2>RINGKASAN AMBULANCE PER KATEGORI</h2>
	</div>
