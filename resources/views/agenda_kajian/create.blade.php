...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('agenda_kajian.create') }}" class="btn btn-primary shadow-sm">
                    ...
                    <tbody>
                        @forelse($agenda as $item)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @if($item->gambar)
                                        <img src="{{ asset('uploads/agenda/'.$item->gambar) }}"
                                             class="img-thumbnail"
                                ...
                                <td class="text-center">
                                    <a href="{{ route('agenda_kajian.edit', $item->id) }}"
                                       class="btn btn-warning btn-sm"
                                       title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </a>

                                    <form action="{{ route('agenda_kajian.destroy', $item->id) }}"
                                          method="POST"
                                          class="d-inline"
