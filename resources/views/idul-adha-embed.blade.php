...
<head>
	...
	<style>
		* {
		...
		.display-background {
			background-image: url('{{ asset("image/display/background/bg_idul_adha.jpg") }}?v=3.0.4') !important;
...
<body>
		...
		<div class="schedule-content-layout">
			...
			<div class="imam-card-box">
				<div class="imam-photo-frame">
					<img src="{{ !empty($idulAdha->foto_imam) ? asset('storage/' . $idulAdha->foto_imam) : asset('image/display/default_imam.jpg') . '?v=3.0.4' }}" alt="Foto Imam" class="imam-photo" onerror="this.onerror=null;this.src='{{ asset('image/display/default_imam.jpg') }}?v=3.0.4';">
	...
	<script>
		...
		if (bgElement) {
			bgElement.style.setProperty('background-image', "url('{{ asset('image/display/background/bg_idul_adha.jpg') }}?v=3.0.4')", 'important');
