{{-- resources/views/idul-adha/edit.blade.php --}}
...
<div class="container-fluid">
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">
			<i class="fas fa-edit"></i> Edit Jadwal Idul Adha
		</h1>
	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			<form action="{{ route('idul-adha.update', $idulAdha) }}" method="POST">
				@csrf
				@method('PUT')
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							value="{{ old('tahun', $idulAdha->tahun) }}" required>
							@error('tahun')
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							value="{{ old('tanggal', $idulAdha->tanggal->format('Y-m-d')) }}" required>
							@error('tanggal')
							<div class="invalid-feedback">{{ $message }}</div>
							@enderror
						</div>
				...
				<div class="row">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							value="{{ old('khatib', $idulAdha->khatib) }}">
							@error('khatib')
							<div class="invalid-feedback">{{ $message }}</div>
							@enderror
						</div>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							value="{{ old('waktu', $idulAdha->waktu ? \Carbon\Carbon::parse($idulAdha->waktu)->format('H:i') : '07:00') }}" placeholder="Format 24 Jam (Contoh: 07:00)">
							@error('waktu')
							<div class="invalid-feedback">{{ $message }}</div>
							@enderror
						</div>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							value="{{ old('keterangan', $idulAdha->keterangan) }}">
							@error('keterangan')
							<div class="invalid-feedback">{{ $message }}</div>
							@enderror
						</div>
