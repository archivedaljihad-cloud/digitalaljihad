		...
		* {
		...
		.header h1 {
			...
			text-shadow: 
				...
				0 8px 25px rgba(0, 0, 0, 0.98) !important;
		...
		<div class="schedule-content-layout">
			...
			<div class="imam-card-box">
				<div class="imam-photo-frame">
					<img src="{{ !empty($sholatJumat->foto_imam) ? asset('storage/' . $sholatJumat->foto_imam) : asset('image/display/default_imam.jpg') . '?v=3.0.4' }}" alt="Foto Imam" class="imam-photo" onerror="this.onerror=null;this.src='{{ asset('image/display/default_imam.jpg') }}?v=3.0.4';">
