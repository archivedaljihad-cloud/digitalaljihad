{{-- resources/views/idul-fitri/create.blade.php --}}
...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			<form action="{{ route('idul-fitri.store') }}" method="POST">
				@csrf
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							value="{{ old('waktu', '07:00') }}" placeholder="Format 24 Jam (Contoh: 07:00)">
							@error('waktu')
							<div class="invalid-feedback">{{ $message }}</div>
							@enderror
						</div>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							value="{{ old('keterangan') }}" placeholder="Contoh: 1 Syawal 1446 H">
							@error('keterangan')
							<div class="invalid-feedback">{{ $message }}</div>
							@enderror
						</div>
