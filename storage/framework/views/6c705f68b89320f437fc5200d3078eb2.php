...
<head>
	...
	<title>Jadwal Sholat Idul Adha - Masjid Digital</title>
...
<body>
	...
	<div class="container">
		<div class="header">
			<h1><?php echo e($settings['nama_aplikasi'] ?? 'Masjid Digital'); ?></h1>
			<div class="datetime" id="datetime"></div>
		</div>
		
		<div class="main-content">
			<?php if(isset($idulAdha) && $idulAdha): ?>
			<div class="idul-card">
				<div class="idul-header">
					<i class="fas fa-drumstick-bite"></i>
					<h2>Sholat Idul Adha</h2>
					<p><?php echo e($idulAdha->tahun); ?> M / <?php echo e($idulAdha->tahun - 1); ?> H</p>
				</div>
				<div class="idul-body">
						...
						<div class="info-grid">
							<div class="info-item">
								...
								<div>
									...
									<div class="value" id="formattedDate">
										...
										?>
										<?php echo e($tanggal->translatedFormat('l')); ?>, <?php echo e($tanggal->translatedFormat('d')); ?> <?php echo e($tanggal->translatedFormat('F')); ?> <?php echo e($tanggal->translatedFormat('Y')); ?>
							...
							<div class="info-item">
								...
								<div>
									...
									<div class="value"><?php echo e(\Carbon\Carbon::parse($idulAdha->waktu)->format('H:i')); ?> WIB</div>
								</div>
							</div>
						</div>
						<?php if($idulAdha->keterangan): ?>
						<div class="date-badge">
							<i class="fas fa-info-circle"></i> <?php echo e($idulAdha->keterangan); ?>
						...
						<div class="officials-grid">
							<div class="official-item">
								...
								<div class="official-info">
									...
									<div class="name"><?php echo e($idulAdha->imam ?? 'Belum Ditentukan'); ?></div>
								</div>
							</div>
							<div class="official-item">
								...
								<div class="official-info">
									...
									<div class="name"><?php echo e($idulAdha->khatib ?? 'Belum Ditentukan'); ?></div>
								</div>
							</div>
							<div class="official-item">
								...
								<div class="official-info">
									...
									<div class="name"><?php echo e($idulAdha->muadzin ?? 'Belum Ditentukan'); ?></div>
								</div>
							</div>
						</div>
					</div>
...
</html><?php /**PATH C:\Users\WhonkNdeso\Documents\Project\DIGITALIZATION\resources\views/idul-adha-embed.blade.php ENDPATH**/ ?>