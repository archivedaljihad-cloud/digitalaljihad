...
<body>
	...
	<div class="container">
		...
		<div class="main-content">
			<?php if(isset($idulFitri) && $idulFitri): ?>
			<div class="idul-card">
				<div class="idul-header">
					<i class="fas fa-moon"></i>
					<h2>Sholat Idul Fitri</h2>
					<p><?php echo e($idulFitri->tahun); ?> M / <?php echo e($idulFitri->tahun - 1); ?> H</p>
				</div>
				<div class="idul-body">
						...
						<div class="info-grid">
							...
							<div class="info-item">
								...
								<div>
									...
									<div class="value"><?php echo e(\Carbon\Carbon::parse($idulFitri->waktu)->format('H:i')); ?> WIB</div>
								</div>
							</div>
						</div>
						<?php if($idulFitri->keterangan): ?>
						<div class="date-badge">
							<i class="fas fa-info-circle"></i> <?php echo e($idulFitri->keterangan); ?>
						...
						<div class="officials-grid">
							<div class="official-item">
								...
								<div class="official-info">
									...
									<div class="name"><?php echo e($idulFitri->imam ?? 'Belum Ditentukan'); ?></div>
								</div>
							</div>
							<div class="official-item">
								...
								<div class="official-info">
									...
									<div class="name"><?php echo e($idulFitri->khatib ?? 'Belum Ditentukan'); ?></div>
								</div>
							</div>
							<div class="official-item">
								...
								<div class="official-info">
									...
									<div class="name"><?php echo e($idulFitri->muadzin ?? 'Belum Ditentukan'); ?></div>
								</div>
							</div>
						</div>
					</div>
...
</html><?php /**PATH C:\Users\WhonkNdeso\Documents\Project\DIGITALIZATION\resources\views/idul-fitri-embed.blade.php ENDPATH**/ ?>