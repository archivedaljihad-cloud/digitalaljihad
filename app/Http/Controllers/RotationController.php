    ...
    public function update(Request $request)
    {
        ...
        $pages = [
            [
                'url'    => 'welcome-embed',
                'name'   => 'Dashboard Lengkap',
                'active' => in_array('welcome-embed', $activePages),
            ],
            [
                'url'    => 'utama-embed',
                'name'   => 'Jadwal Sholat',
                'active' => in_array('utama-embed', $activePages),
            ],
            [
                'url'    => 'keuangan-embed',
                'name'   => 'Rincian Keuangan',
                'active' => in_array('keuangan-embed', $activePages),
            ],
            [
                'url'    => 'jumat-embed',
                'name'   => 'Jadwal Sholat Jumat',
                'active' => in_array('jumat-embed', $activePages),
            ],
            [
                'url'    => 'pengumuman-embed',
                'name'   => 'Pengumuman',
                'active' => in_array('pengumuman-embed', $activePages),
            ],
            [
                'url'    => 'keuangan-summary-embed',
                'name'   => 'Ringkasan Keuangan',
                'active' => in_array('keuangan-summary-embed', $activePages),
            ],
            [
                'url'    => 'qris-embed',
                'name'   => 'QRIS Donasi',
                'active' => in_array('qris-embed', $activePages),
            ],
            [
                'url'    => 'slide-embed',
                'name'   => 'Slide Informasi',
                'active' => in_array('slide-embed', $activePages),
            ],
            [
                'url'    => 'idul-fitri-embed',
                'name'   => 'Idul Fitri',
                'active' => in_array('idul-fitri-embed', $activePages),
            ],
            [
                'url'    => 'idul-adha-embed',
                'name'   => 'Idul Adha',
