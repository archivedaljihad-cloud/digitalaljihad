...
class ProfileController extends Controller
{
    ...
    public function update(Request $request)
    {
        $request->validate([
            ...
            'new_password' => 'nullable|min:6|max:255|required_with:current_password',
            'password_confirmation' => 'nullable|min:6|max:255|required_with:new_password|same:new_password'
        ]);
